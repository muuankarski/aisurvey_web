...
#+ rawdetail
dd <- readRDS("~/btsync/mk/workspace/russia/huippari2016/aisurvey_web/data/structure_merge_with_class.RDS")

metam <- create_metadata(dd)
dm <- strip_attributes(dd)

table_na(dm$v34)

prop.table(table_na(dm$V34c1))*100
prop.table(table_na(dm$V35c1))*100
prop.table(table_na(dm$V34c1))*100
