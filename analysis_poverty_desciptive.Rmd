...
d <- readRDS("../sdmr_processing/output/sdmr2015_data.RDS")
meta <- readRDS("../sdmr_processing/output/sdmr2015_meta.RDS")
...
for (i in bg_vars$code){
  ...
  dd$depend <- factor(dd$depend, 
                      levels=c(c("Below 20",
                                 ...
                                 "60-69",
                                 "70 and older")))
  } else dd$depend <- label_data(dd,i)
