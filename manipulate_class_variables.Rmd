...
tbl <- d15 %>% group_by(V14_CODE_labelled) %>% 
  summarise(occup_groups_labelled = occup_groups_labelled[3],
            occr_labelled = occr_labeled[3],
            skill2_labeled = skill2_labeled[3],
            autonomia_labelled = autonomia_labelled[3],
            mean_AUT_index = mean(AUT_index, na.rm=TRUE),
            mean_DMi_for13 = mean(DMi_for13, na.rm=TRUE))
