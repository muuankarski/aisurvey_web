...
```{r occup_groups}
oldvar <- "V14_CODE_labelled"
oldvar2 <- "occup_groups_labelled"
d[[oldvar2]][d[[oldvar]] %in% c(#1100,1101,
                               ...
                               #  1116,1117,
                               #  1118,1119,
                               "Managing directors and chief executives")] <- "11-Chief executives, senior officials and legislators"

d[[oldvar2]][d[[oldvar]] %in% c("Agricultural and forestry production managers",
                                ...
                                "Supply, distribution and related managers")] <- "13-Production and specialized services managers"

d[[oldvar2]][d[[oldvar]] %in% c("Health services managers",
                                "Aged care services managers",
                               "Social welfare managers",
                               "Education managers",
                               "Financial and insurance services branch managers",
                               #1347,1348,
                               "Professional services managers not elsewhere classified")] <- "53-Personal care workers"

d[[oldvar2]][d[[oldvar]] %in% c("Restaurant managers",
                                # 1413,
                                # 1414,1415,
                                # 1416,1417,
                                # 1418,1419,
                               ...
                               # 1421,
                                ...
                                # 1428,1429,
                                # 1430,
                               "Sports, recreation and cultural centre managers")] <- "13-Production and specialized services managers"

d[[oldvar2]][d[[oldvar]] %in% c("Meteorologists",
"Chemists",
                               ...
                               "Environmental protection professionals")] <- "21-Science and engineering professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Building architects",
                                "Landscape architects",
                               "Product and garment designers",
                               "Town and traffic planners",
                               "Cartographers and surveyors")] <- "21-Science and engineering professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Industrial and production engineers",
                                "Civil engineers",
                               ...
                               "Telecommunications engineers")] <- "3-Technicians and associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Specialist medical practitioners",
                                # 2213,
                                # 2214,2215,
                                # 2216,2217,
                                # 2218,2219,
                               ...
                               "Midwifery professionals")] <- "53-Personal care workers"

d[[oldvar2]][d[[oldvar]] %in% c("Dentists",
                                "Pharmacists",
                               "Environmental and occupational health and hygiene professionals",
                               "Physiotherapists",
                               "Dieticians and nutritionists",
                               "Audiologists and speech therapists")] <- "22-Health professionals"

d[[oldvar2]][d[[oldvar]] %in% c("University and higher education teachers",
                                # 2311,
                                # 2312,2313,
                                # 2314,2315,
                                # 2316,2317,
                               ...
                               #  2326,2327,
                               #  2328,2329,
                               "Secondary education teachers")] <- "23-Teaching professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Primary school teachers",
                                "Early childhood educators")] <- "53-Personal care workers"

d[[oldvar2]][d[[oldvar]] %in% c("Accountants",
                               ...
                               "Training and staff development professionals",
                                ...
                                # 2427,2428,
                                # 2429,2430,
                               "Advertising and marketing professionals")] <- "24-Business and administration professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Software developers",
                               ...
                               "Systems administrators")] <- "25-Information and communications technology professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Lawyers",
                                "Judges",
                                # 2613,2614,
                                # 2615,2616,
                                # 2617,2618,
                               ...
                               "Dancers and choreographers")] <- "26-Legal, social and cultural professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Chemical and physical science technicians",
                               ...
                               "Air traffic controllers")] <- "31-Science and engineering associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Medical imaging and therapeutic equipment technicians",
                               ...
                               "Ambulance workers")] <- "32-Health associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Securities and finance dealers and brokers",
                               ...
                               "Buyers")] <- "33-Business and administration associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Employment agents and contractors",
                                "Real estate agents and property managers")] <- "12-Administrative and commercial managers"

d[[oldvar2]][d[[oldvar]] %in% c("Office supervisors",
                                "Legal secretaries",
                               "Administrative and executive secretaries",
                               "Medical secretaries")] <- "4-Clerical support workers"

d[[oldvar2]][d[[oldvar]] %in% c("Customs and border inspectors",
                               ...
                               # 3356,
                               #  3357,3358,
                               "Regulatory government associate professionals not elsewhere classified")] <- "33-Business and administration associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Police inspectors and detectives",
                               ...
                               "Chefs",
                               "Other artistic and cultural associate professionals")] <- "34-Legal, social, cultural and related associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Information and communications technology operations technicians",
                               ...
                               "Web technicians",
                                ...
                                # 3517,3518,
                                # 3519,3520,
                               "Broadcasting and audio-visual technicians")] <- "35-Information and communications technicians"

d[[oldvar2]][d[[oldvar]] %in% c("General office clerks",
                                # 4111,
                                # 4112,4113,
                                # 4114,4115,
                                # 4116,4117,
                               ...
                               "Data entry clerks")] <- "41-General and keyboard clerks"

d[[oldvar2]][d[[oldvar]] %in% c(#4210,
                               ...
                               "Survey and market research interviewers")] <- "42-Customer services clerks"

d[[oldvar2]][d[[oldvar]]  %in% c("Accounting and bookkeeping clerks",
                                ...
                                "Stock clerks",
                                "Production clerks",
                                "Transport clerks")] <- "43-Numerical and material recording clerks"

d[[oldvar2]][d[[oldvar]] %in% c("Library clerks",
                               ...
                               "Personnel clerks",
                                # 4417,4418,
                               "Clerical support workers not elsewhere classified")] <- "44-Other clerical support workers"

d[[oldvar2]][d[[oldvar]] %in% c("Travel attendants and travel stewards",
                               ...
                               # 5166,
                               #  5167,5168,
                               "Personal services workers not elsewhere classified")] <- "52-Sales workers"

d[[oldvar2]][d[[oldvar]] %in% c("Child care workers",
                                "Teachers aides",
                                # 5313,5314,
                                # 5315,5316,
                                # 5317,5318,
                                # 5319,5320,
                               "Health care assistants")] <- "53-Personal care workers"

d[[oldvar2]][d[[oldvar]] %in% c("Fire-fighters",
                                "Police officers",
                               "Prison guards",
                               "Security guards",
                                # 5415,5416,
                                # 5417,5418,
                               "Protective services workers not elsewhere classified")] <- "11-Chief executives, senior officials and legislators"

d[[oldvar2]][d[[oldvar]] %in% c("Forestry and related workers",
                                # 6211,
                                # 6212,6213,
                                # 6214,6215,
                                # 6216,6217,
                               ...
                               "Deep-sea fishery workers")] <- "6-Skilled agricultural, forestry and fishery workers"

d[[oldvar2]][d[[oldvar]] %in% c("House builders",
                               ...
                               "Building structure cleaners")] <- "7-Craft and related trades workers"

d[[oldvar2]][d[[oldvar]] %in% c("Metal moulders and coremakers",
                               ...
                               "Bicycle and related repairers")] <- "7-Craft and related trades workers"

d[[oldvar2]][d[[oldvar]] %in% c("Precision-instrument makers and repairers",
                               ...
                               "Printers",
                               "Print finishing and binding workers")] <- "7-Craft and related trades workers"

d[[oldvar2]][d[[oldvar]] %in% c("Building and related electricians",
                               ...
                               #  7417,7418,
                               #  7419,7420,
                               "Electronics mechanics and servicers")] <- "7-Craft and related trades workers"

d[[oldvar2]][d[[oldvar]] %in% c("Butchers, fishmongers and related food preparers",
                               ...
                               "Fumigators and other pest and weed controllers",
                                # 7545,7546,
                                # 7547,7548,
                               "Craft and related workers not elsewhere classified")] <- "7-Craft and related trades workers"

d[[oldvar2]][d[[oldvar]] %in% c("Miners and quarriers",
                               ...
                               #  8185,8186,
                               #  8187,8188,
                               "Stationary plant and machine operators not elsewhere classified")] <- "8-Plant and machine operators, and assemblers"

d[[oldvar2]][d[[oldvar]] %in% c("Mechanical machinery assemblers",
                                "Electrical and electronic equipment assemblers",
                                # 8213,8214,
                                # 8215,8216,
                                # 8217,8218,
                               "Assemblers not elsewhere classified")] <- "8-Plant and machine operators, and assemblers"

d[[oldvar2]][d[[oldvar]] %in% c("Locomotive engine drivers",
                               ...
                               "Crane, hoist and related plant operators")] <- "8-Plant and machine operators, and assemblers"

d[[oldvar2]][d[[oldvar]] %in% c("Cleaners and helpers in offices, hotels and other establishments",
                                # 9113,
                                # 9114,9115,
                                # 9116,9117,
                                # 9118,9119,
                               ...
                               "Kitchen helpers")] <- "91-Cleaners and helpers"

d[[oldvar2]][d[[oldvar]] %in% c("Crop farm labourers",
                                "Livestock farm labourers")] <- "92-Agricultural, forestry and fishery labourers"

d[[oldvar2]][d[[oldvar]] %in% c("Civil engineering labourers",
                               ...
                               "Freight handlers",
                               "Shelf fillers",
                               "Kitchen helpers")] <- "92-Agricultural, forestry and fishery labourers"

d[[oldvar2]][d[[oldvar]] %in% c("Sweepers and related labourers",
                                # 9614,
                                # 9615,9616,
                                # 9617,9618,
                                # 9619,9620,
                               ...
                               "Water and firewood collectors",
                                # 9625,9626,
                                # 9627,9628,
                               "Elementary workers not elsewhere classified")] <- "92-Agricultural, forestry and fishery labourers"

d[[oldvar2]][d[[oldvar]] %in% c("Not working",
                                # 9998,
                                "Hard to say")] <- NA

d[[oldvar2]][d[[oldvar]] %in% "Commissioned armed forces officers"] <- "11-Chief executives, senior officials and legislators"

d[[oldvar2]][d[[oldvar]] %in%"Non-commissioned armed forces officers"] <- "34-Legal, social, cultural and related associate professionals"

d[[oldvar2]][d[[oldvar]] %in% c("Education methods specialists",
                               ...
                               "Information technology trainers",
                                # 2357,2358,
                               "Teaching professionals not elsewhere classified")] <- "23-Teaching professionals"
