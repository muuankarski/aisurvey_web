...
download.file("http://muuankarski.kapsi.fi/aisurvey/data/sdmr15.RDS",
              destfile = "./localdata/sdmr15.RDS")
dat <- readRDS("./localdata/sdmr15.RDS")
download.file("http://muuankarski.kapsi.fi/aisurvey/data/label_data.RDS",
              destfile = "./localdata/label_data.RDS")
label_data  <- readRDS("./localdata/label_data.RDS")
```
